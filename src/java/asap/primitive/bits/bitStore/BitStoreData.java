...
public class BitStoreData {
    ...
    public static class BitStoreDataException extends BitStoreException {
        ...
        public BitStoreDataException( String messageFormat,
                                      Object... messageArgs ) {
            super( messageFormat,
                   messageArgs );
        }
    ...
    public static abstract class BitStoreItemData {
        ...
        protected BitStoreItemData( BitStoreViewItemMap bitStoreViewItemMap,
                                    BitStoreRecordData parentRecord ) {
        ...
        public String getPath( ) {
            return String.format( "%s.%s.%s",
                                  this.parentRecord.parentView.getName( ),
        ...
        public String toString( ) {
            ...
            tmpAttributesString.addLine( "name",
                                         this.viewItemMap.getName( ) );
            tmpAttributesString.addLine( "description",
                                         this.viewItemMap.getDescription( ) );
            tmpAttributesString.addLine( "bitLength:",
                                         String.format( "%d",
                                                        this.viewItemMap.getBitLength( ) ) );
            ...
            tmpAttributesString.addLine( new String[ ] { "value:",
                                                         tmpStringValue } );
        ...
        protected < T > void checkValueClass( Class< T > valueClass,
        ...
        protected < T > long convertToLong( T value )
            throws BitStoreDataException {
        ...
        protected < T > void setInteger( T value )
            ...
            if ( ( tmpValueHighestBit > 0 ) && ( tmpValueLength > this.viewItemMap.getBitLength( ) ) ) {
                throw new BitStoreDataException( "Valor '%d' do tipo '%s' ( %d bits ) excede o tamanho do campo '%s' do tipo '%s' ( %d bits ) da visão '%s'",
                                                 tmpValue,
                                                 value.getClass( ).getSimpleName( ),
                                                 tmpValueLength,
                                                 this.viewItemMap.getName( ),
            ...
            this.setBytes( this.isLittleEndianBytes ? ByteHelper.toLittleEndian( tmpValue,
                                                                                 tmpByteLength )
                                                    : ByteHelper.toBigEndian( tmpValue,
                                                                              tmpByteLength ) );
        }
        ...
        protected < T > T getInteger( Class< T > valueClass,
            ...
            if ( this.viewItemMap.getBitLength( ) > tmpMaximumResultLength ) {
                throw new BitStoreDataException( "Tamanho do tipo '%s' ( no máximo %d bits ) não é suficiente para o campo '%s' do tipo '%s' ( %d bits )",
                                                 valueClass.getSimpleName( ),
                                                 tmpMaximumResultLength,
                                                 this.viewItemMap.getName( ),
                                                 this.viewItemMap.getType( ).name( ),
                                                 this.viewItemMap.getBitLength( ) );
            }
        ...
        protected < T > T getInteger( Class< T > valueClass )
            ...
            return this.getInteger( valueClass,
                                    this.isLittleEndianBytes ? ByteHelper.fromLittleEndian( tmpGetBytes )
        ...
        protected void setBits( boolean[ ] bitArray )
            ...
            if ( bitArray.length != this.viewItemMap.getBitLength( ) ) {
                throw new BitStoreDataException( "Quantidade de bits %d inválida para o campo '%s' do tipo '%s' ( %d bits )",
                                                 bitArray.length,
                                                 this.viewItemMap.getName( ),
                                                 this.viewItemMap.getType( ).name( ),
                                                 this.viewItemMap.getBitLength( ) );
    ...
    public static class BitStoreZeroedData extends BitStoreItemData {
        ...
        public BitStoreZeroedData( BitStoreViewRUFMap bitStoreViewRUFMap,
                                   BitStoreRecordData parentRecordData ) {
            super( bitStoreViewRUFMap,
                   parentRecordData );
        }
        ...
        public < T > T getAs( Class< T > valueClass )
            throws BitStoreDataException,
                ...
                BitStoreAuthenticationException,
                BitStoreAccessException {
            this.checkValueClass( valueClass,
                                  byte[ ].class,
                                  String.class );
            ...
            if ( valueClass.isAssignableFrom( String.class ) ) {
                return valueClass.cast( BitHelper.bitArrayToString( tmpBytes,
                                                                    BitHelper.getBitArrayPadLength( tmpBitLength ),
                                                                    tmpBitLength ) );
            }
        ...
        public < T > void setWith( T value )
            throws BitStoreDataException,
                ...
                BitStoreAuthenticationException,
                BitStoreAccessException {
            this.checkValueClass( value.getClass( ),
                                  byte[ ].class );
        ...
        public byte[ ] getBytes( )
            throws BitStoreDeviceException,
                BitStoreSessionException,
                BitStoreAuthenticationException,
                BitStoreAccessException {
        ...
        public void setBytes( byte[ ] bytes )
            ...
            if ( bytes.length != this.viewItemMap.getByteLength( ) ) {
                throw new BitStoreDataException( "Bytes inválidos para o campo '%s' do registro '%s'",
                                                 this.viewItemMap.getName( ),
                                                 this.viewItemMap.getParentViewRecord( ).name );
            }
            for ( byte tmpByte : bytes ) {
                if ( tmpByte != 0 ) {
                    throw new BitStoreDataException( "Valor diferente de zero atribuido ao campo '%s' do registro '%s' na visão '%s' do mapa '%s'",
                                                     this.viewItemMap.getName( ),
                                                     this.viewItemMap.getParentViewRecord( ).name,
                                                     this.viewItemMap.getParentViewRecord( ).getParentView( ).name,
    ...
    public static abstract class BitStoreFieldData extends BitStoreItemData {
        ...
        protected BitStoreFieldData( BitStoreViewFieldMap bitStoreViewFieldMap,
                                     BitStoreRecordData parentRecordData ) {
            super( bitStoreViewFieldMap,
                   parentRecordData );
        ...
        public byte[ ] getBytes( )
            ...
            int tmpMainViewOffset = this.isLittleEndianBits ? 0
                                                            : BitHelper.getBitArrayPadLength( tmpFieldBitLength );
            for ( BitStoreViewPieceMap tmpPieceMap : this.viewFieldMap.getFieldMap( ).getMainViewPieces( ) ) {
                this.parentRecord.getRecordSource( ).getPiece( tmpPieceMap,
            ...
            tmpMainViewOffset = this.isLittleEndianBits ? 0
                                                        : ( ( tmpMainViewBuffer.length * Byte.SIZE ) - tmpBitLength );
            int tmpResultOffset = this.isLittleEndianBits ? 0
                                                          : BitHelper.getBitArrayPadLength( tmpBitLength );
            BitHelper.bitArrayCopy( this.isLittleEndianBits,
                                    tmpMainViewBuffer,
                                    tmpMainViewOffset,
                                    tmpResultBuffer,
                                    tmpResultOffset,
        ...
        public void setBytes( byte[ ] bytes )
            ...
            if ( bytes.length != this.viewFieldMap.getByteLength( ) ) {
                throw new BitStoreDataException( "Bytes inválidos para o campo '%s' do registro '%s'",
                                                 ...
                                                 this.viewFieldMap.getParentViewRecord( ).name );
            }
            byte[ ] tmpMainBytes;
            ...
            if ( tmpMainBitLength == tmpBitLength ) {
                ...
                if ( this.isLittleEndianBits ) {
                    tmpMainBytes = BitHelper.copyOfLeftAlignedBitArray( bytes,
                                                                        tmpBitLength,
                                                                        tmpMainBitLength );
                }
                else {
                    tmpMainBytes = BitHelper.copyOfRightAlignedBitArray( bytes,
                                                                         tmpBitLength,
                                                                         tmpMainBitLength );
                }
            }
            int tmpMainOffset = this.isLittleEndianBits ? 0
                                                        : BitHelper.getBitArrayPadLength( tmpMainBitLength );
            for ( BitStoreViewPieceMap tmpPieceMap : this.viewFieldMap.getFieldMap( ).getMainViewPieces( ) ) {
                this.parentRecord.getRecordSource( ).setPiece( tmpPieceMap,
                                                               this.isLittleEndianBits,
                                                               tmpMainBytes,
                                                               tmpMainOffset );
    ...
    public static class BitStoreBooleanFieldData extends BitStoreFieldData {
        ...
        protected BitStoreBooleanFieldData( BitStoreBooleanFieldMap bitStoreBooleanFieldMap,
                                            BitStoreViewFieldMap bitStoreViewFieldMap,
                                            BitStoreRecordData parentRecordData ) {
            super( bitStoreViewFieldMap,
                   parentRecordData );
        ...
        public < T > T getAs( Class< T > valueClass )
            ...
            if ( valueClass.isAssignableFrom( Boolean.class ) ) {
                ...
                return valueClass.cast( ( this.getInteger( Long.class ) != 0 ) ? this.trueString
                                                                               : this.falseString );
            }
            return this.getInteger( valueClass );
        }
        ...
        public < T > void setWith( T value )
            ...
            if ( value instanceof Boolean ) {
                this.setInteger( ( (Boolean) value ).booleanValue( ) ? 1
                                                                     : 0 );
            }
                ...
                if ( tmpStringValue.compareToIgnoreCase( this.trueString ) == 0 ) {
                    ...
                    throw new BitStoreDataException( "String '%s' não pode ser atribuída ao campo '%s' do tipo '%s' ( somente '%s' ou '%s' )",
                                                     tmpStringValue,
                                                     this.viewFieldMap.getName( ),
                                                     this.viewFieldMap.getType( ).name( ),
                                                     this.trueString,
                                                     this.falseString );
                }
            }
    ...
    public static class BitStoreRUFFieldData extends BitStoreFieldData {
        ...
        protected BitStoreRUFFieldData( BitStoreViewFieldMap bitStoreViewFieldMap,
                                        BitStoreRecordData parentRecordData ) {
            super( bitStoreViewFieldMap,
                   parentRecordData );
        }
        ...
        public < T > T getAs( Class< T > valueClass )
            ...
            if ( valueClass.isAssignableFrom( String.class ) ) {
                ...
                if ( ( tmpDefaultBase != null ) && ( tmpDefaultBase == 16 ) ) {
                    int tmpHexaDigits = ( BitHelper.getBitArrayBufferLength( this.viewFieldMap.getFieldMap( ).getBitLength( ) )
                                          * 2 );
                    String tmpFormat = String.format( "0x%%0%dX",
                                                      tmpHexaDigits );
                    tmpValueString = String.format( tmpFormat,
                                                    tmpValue );
                }
                else {
            ...
            if ( value instanceof String ) {
                ...
                if ( ( tmpDefaultBase != null ) && ( tmpDefaultBase == 16 ) ) {
                    if ( !tmpStringValue.matches( "0x[0-9A-Fa-f]+" ) ) {
                        throw new BitStoreDataException( "String '%s' não pode ser atribuída ao campo '%s' do tipo '%s' ( inteiro de %d bits em base 16 )",
                                                         StringHelper.wrap( tmpStringValue,
                                                                            20 ),
                                                         this.viewFieldMap.getName( ),
                                                         this.viewFieldMap.getType( ).name( ),
                                                         this.viewFieldMap.getBitLength( ) );
                    }
                    tmpLongValue = Long.parseLong( tmpStringValue.replaceAll( "0x",
                                                                              "" ),
                                                   16 );
                }
                else {
    ...
    public static class BitStoreDateFieldData extends BitStoreFieldData {
        ...
        public static final Date             REFERENCE_DATE = new GregorianCalendar( 2000,
                                                                                     0,
                                                                                     1 ).getTime( );
        ...
        public static int computeDayOffset( Date date ) {
            return DateTimeHelper.computeElapsedDays( date,
                                                      BitStoreDateFieldData.REFERENCE_DATE );
        }

        public static Date computeDatetime( int relativeDays,
                                            int relativeMinutes ) {
            if ( ( relativeDays == 0 ) && ( relativeMinutes == 0 ) ) {
                return new Date( 0 );
            }
            return DateTimeHelper.computeElapsedDate( BitStoreDateFieldData.REFERENCE_DATE,
                                                      relativeDays,
                                                      0,
                                                      relativeMinutes,
                                                      0 );
        ...
        public < T > T getAs( Class< T > valueClass )
            ...
            if ( valueClass.isAssignableFrom( Date.class ) || valueClass.isAssignableFrom( String.class ) ) {
                ...
                tmpDate.add( Calendar.DAY_OF_MONTH,
                             this.getInteger( Integer.class ).intValue( ) );
            ...
            if ( value instanceof Date ) {
                ...
                try {
                    ...
                    throw new BitStoreDataException( "String '%s' não pode ser convertida para data no formato '%s'",
                                                     tmpString,
                                                     BitStoreDateFieldData.DATE_FORMAT.toLocalizedPattern( ) );
                }
            }
            else {
                this.setInteger( value );
        ...
        public < T > T getAs( Class< T > valueClass )
            ...
            if ( valueClass.isAssignableFrom( String.class ) ) {
                ...
                tmpCalendar.set( Calendar.HOUR_OF_DAY,
                                 0 );
                tmpCalendar.set( Calendar.MINUTE,
                                 0 );
            ...
            if ( ( value instanceof Date ) || ( value instanceof String ) ) {
                ...
                if ( value instanceof Date ) {
                    ...
                    try {
                        ...
                        throw new BitStoreDataException( "String '%s' não pode ser convertida para horário no formato '%s'",
                                                         tmpString,
                                                         BitStoreTimeFieldData.TIME_FORMAT.toLocalizedPattern( ) );
                    }
                }
                this.setInteger( ( tmpCalendar.get( Calendar.HOUR_OF_DAY ) * 60 )
    ...
    public static class BitStoreEnumerationData extends BitStoreFieldData {
        ...
        public < T > T getAs( Class< T > valueClass )
            ...
            if ( ( tmpIsInverted != null ) && tmpIsInverted.booleanValue( ) ) {
                int tmpBitLength = this.viewFieldMap.getBitLength( );
                BitHelper.bitArrayInvert( tmpValue,
                                          BitHelper.getBitArrayPadLength( tmpBitLength ),
                                          tmpBitLength );
            }
            ...
            for ( BitStoreEnumerationFieldItemMap tmpEnumerationItem : ( (BitStoreEnumerationFieldMap) this.viewFieldMap.getFieldMap( ) ).getItems( ) ) {
            ...
            if ( valueClass.isAssignableFrom( BitStoreEnumerationFieldItemMap.class ) ) {
                ...
                return valueClass.cast( String.format( "%d - %s",
                                                       tmpIntegerValue,
                                                       tmpEnumerationValue.name ) );
            }
            return this.getInteger( valueClass,
                                    ( this.isLittleEndianBytes ? ByteHelper.fromLittleEndian( tmpValue )
                                                               : ByteHelper.fromBigEndian( tmpValue ) ) );
        ...
        public < T > void setWith( T value )
            ...
            if ( value instanceof String ) {
                ...
                if ( tmpValueString.matches( tmpPattern ) ) {
                    tmpValueString = tmpValueString.replaceAll( tmpPattern,
                                                                "$1" );
                }
                for ( BitStoreEnumerationFieldItemMap tmpEnumerationItem : ( (BitStoreEnumerationFieldMap) this.viewFieldMap.getFieldMap( ) ).getItems( ) ) {
                    if ( tmpEnumerationItem.name.compareTo( tmpValueString ) == 0 ) {
                        int tmpByteLength = this.viewFieldMap.getByteLength( );
                        byte[ ] tmpValue = ( this.isLittleEndianBytes ? ByteHelper.toLittleEndian( tmpEnumerationItem.value,
                                                                                                   tmpByteLength )
                                                                      : ByteHelper.toBigEndian( tmpEnumerationItem.value,
                                                                                                tmpByteLength ) );
                        Boolean tmpIsInverted = ( (BitStoreEnumerationFieldMap) this.viewFieldMap.getFieldMap( ) ).inverted;
                        if ( ( tmpIsInverted != null ) && tmpIsInverted.booleanValue( ) ) {
                            int tmpBitLength = this.viewFieldMap.getBitLength( );
                ...
                throw new BitStoreDataException( "Nenhum ítem com o nome '%s' no campo enumerado '%s'",
                                                 ( (String) value ),
                                                 this.viewFieldMap.getName( ) );
            }
            else {
                ...
                //
                byte[ ] tmpBytes = ( this.isLittleEndianBytes ? ByteHelper.toLittleEndian( tmpLongValue,
                                                                                           this.viewFieldMap.getByteLength( ) )
                                                              : ByteHelper.toBigEndian( tmpLongValue,
                                                                                        this.viewFieldMap.getByteLength( ) ) );
                super.setBytes( tmpBytes );
                if ( false ) {
                    for ( BitStoreEnumerationFieldItemMap tmpEnumerationItemMap : ( (BitStoreEnumerationFieldMap) this.viewFieldMap.getFieldMap( ) ).getItems( ) ) {
    ...
    public static class BitStoreIntegerArrayFieldData extends BitStoreFieldData {
        ...
        protected < T > void checkIntegerArray( Class< T > valueClass )
            throws BitStoreDataException {
            int tmpTypeSize;
            ...
            if ( tmpTypeSize < this.integerLength ) {
                throw new BitStoreDataException( "Tamanho do tipo '%s' ( %d bits ) não é suficiente para o campo '%s' do tipo '%s' ( %d bits )",
                                                 valueClass.getSimpleName( ),
                                                 tmpTypeSize,
                                                 this.viewFieldMap.getName( ),
                                                 this.viewFieldMap.getType( ).name( ),
        ...
        public < T > T getAs( Class< T > valueClass )
            ...
            if ( valueClass.isAssignableFrom( String.class ) ) {
                ...
                for ( int tmpLongIndex = 0; tmpLongIndex < tmpLongArray.length; tmpLongIndex++ ) {
                    byte[ ] tmpBytes = BitHelper.subBitArray( this.getBytes( ),
                                                              tmpBitOffset,
                                                              this.integerLength );
        ...
        public < T > void setWith( T value )
            ...
            if ( value instanceof String ) {
                ...
                if ( !tmpValue.matches( "\\[( *\\d+,)* *\\d+ *\\]" ) ) {
                    throw new BitStoreDataException( "String '%s' não pode ser atribuída ao campo '%s' do tipo '%s' ( array de %d inteiros de %d bits )",
                                                     StringHelper.wrap( tmpValue,
                                                                        20 ),
                                                     this.viewFieldMap.getName( ),
                                                     this.viewFieldMap.getType( ).name( ),
                                                     this.arrayLength,
                ...
                String[ ] tmpArray = tmpValue.replaceAll( "[\\[\\] ]",
                                                          "" ).split( "," );
                if ( tmpArray.length != this.arrayLength ) {
                    throw new BitStoreDataException( "Array '%s' ( %d elementos ) não pode ser atribuída ao campo '%s' do tipo '%s' ( array de %d inteiros de %d bits )",
                                                     StringHelper.wrap( tmpValue,
                                                                        20 ),
                                                     tmpArray.length,
                                                     this.viewFieldMap.getName( ),
                ...
                for ( int tmpIntegerIndex = 0; tmpIntegerIndex < this.arrayLength; tmpIntegerIndex++ ) {
                    try {
                        tmpElementArray[ tmpIntegerIndex ] = (Long) BitStoreIntegerFieldData.DECIMAL_FORMAT.parse( tmpArray[ tmpIntegerIndex ] );
                    }
                    catch ( ParseException e ) {
                ...
                if ( Array.getLength( value ) != this.arrayLength ) {
                    throw new BitStoreDataException( "Array do tipo '%s' ( %d elementos ) não pode ser atribuída ao campo '%s' do tipo '%s' ( array de %d inteiros de %d bits )",
                                                     value.getClass( ).getSimpleName( ),
                ...
                if ( value instanceof byte[ ] ) {
                    for ( int tmpByteIndex = 0; tmpByteIndex < this.arrayLength; tmpByteIndex++ ) {
                        tmpElementArray[ tmpByteIndex ] = Array.getByte( value,
                                                                         tmpByteIndex );
                    }
                }
                else if ( value instanceof short[ ] ) {
                    for ( int tmpShortIndex = 0; tmpShortIndex < this.arrayLength; tmpShortIndex++ ) {
                        tmpElementArray[ tmpShortIndex ] = Array.getShort( value,
                                                                           tmpShortIndex );
                    }
                }
                else if ( value instanceof int[ ] ) {
                    for ( int tmpIntegerIndex = 0; tmpIntegerIndex < this.arrayLength; tmpIntegerIndex++ ) {
                        tmpElementArray[ tmpIntegerIndex ] = Array.getInt( value,
                                                                           tmpIntegerIndex );
                    }
                }
                else if ( value instanceof long[ ] ) {
                    for ( int tmpLongIndex = 0; tmpLongIndex < this.arrayLength; tmpLongIndex++ ) {
                        tmpElementArray[ tmpLongIndex ] = Array.getLong( value,
                                                                         tmpLongIndex );
                    }
                }
            }
            ...
            for ( int tmpElementIndex = 0; tmpElementIndex < this.arrayLength; tmpElementIndex++ ) {
                ...
                BitHelper.bitArrayCopy( tmpElementBytes,
                                        tmpElementOffset,
                                        tmpBuffer,
                                        tmpBufferOffset,
                                        this.integerLength );
    ...
    public static class BitStoreRecordData {
        ...
        protected BitStoreRecordData( BitStoreViewRecordMap viewRecordMap,
                                      BitStoreRecordSource bitStoreRecordSource,
        ...
        public BitStoreRecordData[ ] getViews( )
            throws BitStoreMapException {
        ...
        public BitStoreRecordData getView( String viewName )
            throws BitStoreMapException {
        ...
        public BitStoreItemData getItem( String fieldName )
            throws BitStoreMapException {
            BitStoreItemData tmpResult = this.searchItem( fieldName );
            if ( tmpResult == null ) {
                throw new BitStoreMapException( "Nenhum ítem com o nome '%s' na visão '%s' do registro '%s'",
                                                fieldName,
                                                this.viewRecordMap.getParentView( ).name,
                                                this.viewRecordMap.name );
            }
            return tmpResult;
        }
        ...
        public BitStoreFieldData getField( String fieldName )
            throws BitStoreMapException {
            BitStoreFieldData tmpResult = this.searchField( fieldName );
            if ( tmpResult == null ) {
                throw new BitStoreMapException( "Nenhum campo com o nome '%s' na visão '%s' do registro '%s'",
                                                fieldName,
                                                this.viewRecordMap.getParentView( ).name,
                                                this.viewRecordMap.name );
            }
        ...
        public byte[ ] getBytes( )
            ...
            for ( BitStoreFieldData tmpRecordItemData : this.fields ) {
                ...
                for ( BitStoreViewPieceMap tmpViewPiece : tmpRecordItemData.getViewFieldMap( ).getPieces( ) ) {
                    BitHelper.bitArrayCopy( this.isLittleEndianBytes,
                                            tmpBytes,
                                            tmpFieldViewOffset,
                                            tmpResult,
                                            tmpViewPiece.offset,
        ...
        public void setBytes( byte[ ] bytes )
            ...
            if ( bytes.length != this.viewRecordMap.getByteLength( ) ) {
                throw new BitStoreDataException( "Bytes inválidos para o registro '%s'",
                                                 this.viewRecordMap.name );
            }
    ...
    public class BitStoreViewData {
        ...
        protected BitStoreViewData( BitStoreViewMap viewMap,
                                    BitStoreData parentStore )
            throws BitStoreMapException {
            ...
            for ( BitStoreViewRecordMap tmpViewRecord : viewMap.getRecords( ) ) {
                this.records[ tmpIndex++ ] = new BitStoreRecordData( tmpViewRecord,
                                                                     tmpStoreSource.getRecord( tmpViewRecord.getName( ) ),
                                                                     this );
            }
        ...
        public BitStoreRecordData getRecord( int recordIndex )
            throws BitStoreMapException {
            if ( ( recordIndex < 0 ) || ( recordIndex >= this.records.length ) ) {
                throw new BitStoreMapException( "Índice de registro '%d' é inválido na visão '%s' do mapa '%s'",
                                                this.viewMap.name,
                                                this.viewMap.getStoreMap( ).name );
            }
            return this.records[ recordIndex ];
        }

        public BitStoreRecordData getRecord( String recordName )
            throws BitStoreMapException {
            BitStoreRecordData tmpResult = this.searchRecord( recordName );
            if ( tmpResult == null ) {
                throw new BitStoreMapException( "Não há registro '%s' na visão '%s' do mapa '%s'",
                                                recordName,
                                                this.viewMap.name,
                                                this.viewMap.getStoreMap( ).name );
            }
        ...
        public BitStoreItemData searchItem( String itemPath )
            throws BitStoreMapException {
            String[ ] tmpItemPath = itemPath.split( "\\." );
            if ( tmpItemPath.length != 2 ) {
                throw new BitStoreMapException( "Caminho '%s' inválido para ítem da visão '%s'",
                                                itemPath,
        ...
        public BitStoreItemData getItem( String itemPath )
            throws BitStoreMapException {
            String[ ] tmpItemPath = itemPath.split( "\\." );
            if ( tmpItemPath.length != 2 ) {
                throw new BitStoreMapException( "Caminho '%s' inválido para ítem da view '%s'",
                                                itemPath,
    ...
    public BitStoreData( BitStoreMap storeMap,
                         BitStoreSource storeSource )
        throws BitStoreMapException {
        this.storeMap = storeMap;
        this.storeSource = storeSource;
        this.mainView = new BitStoreViewData( this.storeMap.getMainView( ),
                                              this );
        ...
        for ( int tmpIndex = 0; tmpIndex < this.alternativeViews.length; tmpIndex++ ) {
            this.alternativeViews[ tmpIndex ] = new BitStoreViewData( this.storeMap.alternativeViews[ tmpIndex ],
                                                                      this );
        }
    ...
    public BitStoreData( BitStoreMap bitStoreMap )
        throws BitStoreMapException {
        this( bitStoreMap,
              new BitStoreMemorySource( bitStoreMap ) );
    }
    ...
    public BitStoreViewData getView( String viewName )
        throws BitStoreMapException {
    ...
    public BitStoreItemData getItem( String itemPath )
        ...
        if ( tmpItemPath.length != 3 ) {
            throw new BitStoreMapException( "Caminho '%s' inválido para ítem do store '%s'",
                                            itemPath,
                                            this.getMap( ).getName( ) );
        }
    ...
    public BitStoreRecordData getRecord( String recordPath )
        throws BitStoreMapException {
        String[ ] tmpItemPath = recordPath.split( "\\." );
        if ( tmpItemPath.length != 2 ) {
            throw new BitStoreMapException( "Caminho '%s' inválido para registro do store '%s'",
                                            recordPath,
                                            this.getMap( ).getName( ) );
        }
